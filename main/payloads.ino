...
*/
String createSensorDataPayload(String temp, String hum, String mq, String light, String zmpt, String acs, String acsPower) {
    DynamicJsonDocument doc(1024);
...
void handleConfigUpdate(String payload) {
    ...
    if (doc["type"] != PayloadTypes::CONFIG_UPDATE) {
        return;
    }

    JsonObject configData = doc["data"]["config"];
...
void handleCommand(String payload) {
    ...
    if (doc["type"] != PayloadTypes::COMMAND) {
        return;
    }
